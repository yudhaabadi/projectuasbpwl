	...
	<footer class="bg6 p-t-45 p-b-43 p-l-45 p-r-45">
		<div class="flex-w p-b-90">
			...
			<div class="w-size7 p-t-30 p-l-15 p-r-15 respon4">
				...
				<ul>
					...
					<li class="p-b-9">
						<a href="<?php echo base_url('produk/kategori/'.$nav_produk_footer->slug_produk) ?>" class="s-text7">
		...
		<div class="t-center p-l-15 p-r-15">
			...
			<div class="t-center s-text8 p-t-20">
				Copyright © 2019 All rights reserved. | <i class="fa fa-heart-o" aria-hidden="true"></i> <a href="<?php echo base_url('home') ?>" target="_blank">HiStyle</a>
			</div>
		</div>
	</footer>
